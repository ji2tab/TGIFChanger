...
# License:     GPL v3
# Description: Monitors MMDVMHost logs, controls GPIO LEDs, and manages 
#              auto-restore timers with real-time Web UI synchronization.
# =============================================================================
...
def main_loop():
    log(f"🚀 TGIFChanger-Py {VERSION} 監視プロセスを開始します。")
